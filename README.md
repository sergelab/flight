...
В v0.3 зафиксирована **стабильная базовая картинка без мерцания**:
...
В этой версии **нет** процедурной "текстуры" (контуров/noise) — это сознательное решение, чтобы убрать shimmer на движении камеры.
